...
INSERT INTO `user_roles` (`created_at`, `updated_at`, `user_id`, `event_id`, `role`) SELECT `created_at`, `created_at`, `creator_id`, `id`, 'organizer' FROM `events`;
-- Copy existing participants
INSERT INTO `user_roles` (`created_at`, `updated_at`, `user_id`, `event_id`, `role`) SELECT `created_at`, `created_at`, `user_id`, `event_id`, 'participant' FROM `sold_tickets`;