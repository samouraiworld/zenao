...
export const file_zenao_v1_zenao: GenFile = /*@__PURE__*/
  fileDesc("", [file_polls_v1_polls]);
...
/**
 * @generated from message zenao.v1.CreateStandardPostRequest
 */
export type CreateStandardPostRequest = Message<"zenao.v1.CreateStandardPostRequest"> & {
  /**
   * @generated from field: string event_id = 1;
   */
  eventId: string;
 ...
 * @generated from message zenao.v1.CreateStandardPostRequest
 */
export type CreateStandardPostRequestJson = {
  /**
   * @generated from field: string event_id = 1;
   */
  eventId?: string;
...
/**
 * Describes the message zenao.v1.CreateStandardPostRequest.
 * Use `create(CreateStandardPostRequestSchema)` to create a new message.
 */
export const CreateStandardPostRequestSchema: GenMessage<CreateStandardPostRequest, CreateStandardPostRequestJson> = /*@__PURE__*/
  messageDesc(file_zenao_v1_zenao, 21);

/**
 * @generated from message zenao.v1.CreateStandardPostResponse
 */
export type CreateStandardPostResponse = Message<"zenao.v1.CreateStandardPostResponse"> & {
  /**
   * @generated from field: string post_id = 1;
   */
  postId: string;
 ...
 * @generated from message zenao.v1.CreateStandardPostResponse
 */
export type CreateStandardPostResponseJson = {
  /**
   * @generated from field: string post_id = 1;
   */
  postId?: string;
...
/**
 * Describes the message zenao.v1.CreateStandardPostResponse.
 * Use `create(CreateStandardPostResponseSchema)` to create a new message.
 */
export const CreateStandardPostResponseSchema: GenMessage<CreateStandardPostResponse, CreateStandardPostResponseJson> = /*@__PURE__*/
