...
func file_zenao_v1_zenao_proto_rawDescGZIP() []byte {
	file_zenao_v1_zenao_proto_rawDescOnce.Do(func() {
		file_zenao_v1_zenao_proto_rawDescData = string(protoimpl.X.CompressGZIP([]byte(file_zenao_v1_zenao_proto_rawDescData)))
	})
	return []byte(file_zenao_v1_zenao_proto_rawDescData)
}
