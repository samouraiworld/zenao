...
type CreatePollRequest struct {
	...
	Duration      uint64                 `protobuf:"varint,3,opt,name=duration,proto3" json:"duration,omitempty"` // unix seconds
	Kind          v1.PollKind            `protobuf:"varint,4,opt,name=kind,proto3,enum=polls.v1.PollKind" json:"kind,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CreatePollRequest) GetDuration() uint64 {
	if x != nil {
		return x.Duration
	}
	return 0
...
var file_zenao_v1_zenao_proto_rawDesc = string([]byte{
	...
	0x63, 0x6b, 0x65, 0x74, 0x53, 0x65, 0x63, 0x72, 0x65, 0x74, 0x22, 0xf0, 0x01, 0x0a, 0x0d, 0x45,
	...
	0x73, 0x73, 0x65, 0x73, 0x22, 0x8d, 0x01, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x50,
	0x6f, 0x6c, 0x6c, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1a, 0x0a, 0x08, 0x71, 0x75,
	...
	0x28, 0x04, 0x52, 0x08, 0x64, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x26, 0x0a, 0x04,
	0x6b, 0x69, 0x6e, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x12, 0x2e, 0x70, 0x6f, 0x6c,
	0x6c, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x50, 0x6f, 0x6c, 0x6c, 0x4b, 0x69, 0x6e, 0x64, 0x52, 0x04,
	0x6b, 0x69, 0x6e, 0x64, 0x22, 0x24, 0x0a, 0x12, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x50, 0x6f,
	0x6c, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x32, 0xcd, 0x03, 0x0a, 0x0c, 0x5a,
	...
	0x6c, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x39, 0x5a, 0x37, 0x67, 0x69,
...
var file_zenao_v1_zenao_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_zenao_v1_zenao_proto_goTypes = []any{
	...
	(v1.PollKind)(0),               // 19: polls.v1.PollKind
}
var file_zenao_v1_zenao_proto_depIdxs = []int32{
	...
	19, // 7: zenao.v1.CreatePollRequest.kind:type_name -> polls.v1.PollKind
	...
	1,  // 14: zenao.v1.ZenaoService.EditUser:output_type -> zenao.v1.EditUserResponse
	3,  // 15: zenao.v1.ZenaoService.GetUserAddress:output_type -> zenao.v1.GetUserAddressResponse
	5,  // 16: zenao.v1.ZenaoService.CreateEvent:output_type -> zenao.v1.CreateEventResponse
	7,  // 17: zenao.v1.ZenaoService.EditEvent:output_type -> zenao.v1.EditEventResponse
	9,  // 18: zenao.v1.ZenaoService.Participate:output_type -> zenao.v1.ParticipateResponse
	18, // 19: zenao.v1.ZenaoService.CreatePoll:output_type -> zenao.v1.CreatePollResponse
