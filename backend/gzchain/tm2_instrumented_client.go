...
// TM2Client is an HTTP client implementation
...
// NewTM2Client initializes and creates a new HTTP RPC client
func NewTM2Client(ctx context.Context, rpcURL string) (*TM2Client, error) {
	// Parse the RPC URL
...
func (c *TM2Client) SendRequest(ctx context.Context, request types.RPCRequest) (*types.RPCResponse, error) {
	// Send the request
	response, err := sendRequestCommon[types.RPCRequest, *types.RPCResponse](c.ctx, c.client, c.rpcURL, request)
	if err != nil {
		return nil, err
	}
...
func (c *TM2Client) SendBatch(ctx context.Context, requests types.RPCRequests) (types.RPCResponses, error) {
	// Send the batch
	responses, err := sendRequestCommon[types.RPCRequests, types.RPCResponses](c.ctx, c.client, c.rpcURL, requests)
	if err != nil {
		return nil, err
	}
