...
export const EventEditedEmail = () => (
    <Html>
        <Head />
        <Body style={main}>
            <Preview>The event {"{{.EventName }}"} has been edited</Preview>
            <Container style={container}>
                ...
                <Section style={details.section}>
                    <Row>
                        <Column>
                            <Heading style={details.headingText}>The event has been updated</Heading>
                        </Column>
                    </Row>
                    <Row>
                        <Column>
...
export default EventEditedEmail;
